...
from api.thewatsoncrew.Intelligence.tools.teacher.setup import ReadingInfo
import pandas as pd
import asyncio
...
def llm_made_links_knowledge_base(links:List[str]):
    ...
    KB_Creator.ordering_content(pd.read_csv('api/thewatsoncrew/Intelligence/tools/teacher/clustering_results.csv'))
